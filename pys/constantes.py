...
POS_BOTAO_SELECIONAR_LICENCA = tuple(constantes["POS_BOTAO_SELECIONAR_LICENCA"])
AREA_BOTAO_SELECIONAR_LICENCA = tuple(constantes["AREA_SELECIONAR_LICENCA"])
...
PATH_IMGS_ANCORAS_CRAFTS_ESPECIAIS = os.path.join(BASE_DIR, '..\\imgs\\ancoras\\ancoras crafts especiais\\')
...
PATH_IMGS_ANCORAS_LICENCA = os.path.join(BASE_DIR, '..\\imgs\\ancoras\\ancoras licenca\\')
...
PATH_PRINT = os.path.join(BASE_DIR, '..\\print_gerado_da_area.png')
PATH_ENV = os.path.join(BASE_DIR, '..\\telegram.env')